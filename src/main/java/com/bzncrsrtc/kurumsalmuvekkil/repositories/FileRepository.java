...
public interface FileRepository extends JpaRepository<File, UUID> {
	...
	List<File> findAllByCompanyId(UUID companyId);
	List<File> findAllByCompanyIdAndDeleted(UUID companyId, boolean deleted);
	List<File> findAllByCompanyIdAndDeletedAndActive(UUID companyId, boolean deleted, boolean active);
